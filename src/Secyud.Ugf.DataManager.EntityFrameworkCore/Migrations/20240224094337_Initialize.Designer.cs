...
namespace Secyud.Ugf.DataManager.Migrations
{
    ...
    [Migration("20240224094337_Initialize")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Secyud.Ugf.DataManager.DataCollection", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Secyud.Ugf.DataManager.DataCollectionObject", b =>
                {
                    ...
                    b.HasKey("ConfigId", "ObjectId");

                    b.HasIndex("ConfigId", "ObjectId");

                    b.ToTable("DataCollectionObject");
                });

            modelBuilder.Entity("Secyud.Ugf.DataManager.DataObject", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Secyud.Ugf.DataManager.DataCollectionObject", b =>
                {
                    b.HasOne("Secyud.Ugf.DataManager.DataCollection", null)
                        .WithMany("DataCollectionObjects")
            ...
            modelBuilder.Entity("Secyud.Ugf.DataManager.DataCollection", b =>
                {
                    b.Navigation("DataCollectionObjects");
                });
