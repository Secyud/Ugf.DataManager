...
namespace Secyud.Ugf.DataManager.Migrations
{
    /// <inheritdoc />
    public partial class Initialize : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DataCollectionObject", x => new { x.ConfigId, x.ObjectId });
                    table.ForeignKey(
                        name: "FK_DataCollectionObject_DataCollections_ConfigId",
                        column: x => x.ConfigId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DataCollectionObject_ConfigId_ObjectId",
                table: "DataCollectionObject",
                columns: new[] { "ConfigId", "ObjectId" });

            migrationBuilder.CreateIndex(
                name: "IX_DataCollections_Name",
                table: "DataCollections",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "IX_DataObjects_BundleId",
                table: "DataObjects",
                column: "BundleId");

            migrationBuilder.CreateIndex(
                name: "IX_DataObjects_ClassId",
                table: "DataObjects",
                column: "ClassId");

            migrationBuilder.CreateIndex(
                name: "IX_DataObjects_ResourceId",
                table: "DataObjects",
                column: "ResourceId");
