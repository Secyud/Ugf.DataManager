...
namespace Secyud.Ugf.DataManager.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("DataManager") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "DataManager", DisplayName = "DataManager API", Resources = { "DataManager" }
            });
        }
    }
